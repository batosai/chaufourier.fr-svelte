<section class="px-4 py-24 mx-auto max-w-7xl">
  ...
  >
    <div>
      <a href="#">
        <img
          src="https://via.placeholder.com/380x220"
      ...
      <h2 class="mb-2 text-lg font-semibold text-gray-900">
        <a href="#" class="text-gray-900 hover:text-blue-700"
          >Process Documents Using Artificial Intelligence For RPA Bots</a
        >
      </h2>
      ...
      <p class="mb-3 text-sm font-normal text-gray-500">
        <a href="#" class="font-medium text-gray-900 hover:text-blue-700"
          >Praveen Juge</a
        >
        • April 16, 2020
      </p>
    ...
    <div>
      ...
      <h2 class="mb-2 text-lg font-semibold text-gray-900">
        <a href="#" class="text-gray-900 hover:text-blue-700"
          >Implement Dark Mode in Your Android App</a
        >
      </h2>
      <p class="mb-3 text-sm font-normal text-gray-500">
        ...
        Application. Don’t waste your time; just implement and enjoy Dark Mode.
      </p>
      <p class="mb-3 text-sm font-normal text-gray-500">
        <a href="#" class="font-medium text-gray-900 hover:text-blue-700"
          >Praveen Juge</a
    ...
    <div>
      ...
      <h2 class="mb-2 text-lg font-semibold text-gray-900">
        <a href="#" class="text-gray-900 hover:text-blue-700"
          >Why is Mental Health one of the Important Issues to Address?</a
        >
      </h2>
      <p class="mb-3 text-sm font-normal text-gray-500">
        ...
        of the important issues to address not only in the work sector but also
        in daily living.
      </p>
      <p class="mb-3 text-sm font-normal text-gray-500">
        <a href="#" class="font-medium text-gray-900 hover:text-blue-700"
